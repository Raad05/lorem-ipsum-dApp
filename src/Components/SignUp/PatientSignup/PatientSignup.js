            ...
            <div className="login-form w-1/4 h-1/2 m-auto mt-10">
                <form>
                    <label className='flex items-center justify-between'>
                        ...
                        <input type="text" placeholder="First name" className="input w-3/4 mb-5" />
                    </label>
                    <label className='flex items-center justify-between'>
                        <p className='mb-3 text-xl'>Last Name: </p>
                        <input type="text" placeholder="Last name" className="input w-3/4 mb-5" />
                    </label>
                    <label className='flex items-center justify-between'>
                        <p className='mb-3 text-xl'>NID: </p>
                        <input type="text" placeholder="NID number and upload NID" className="input w-4/5 mb-5" />
                    </label>
                    <label className='flex items-center justify-between'>
                        <p className='mb-3 text-xl'>Date of Birth: </p>
                        <input type="text" placeholder="DD/ MM/ YYYY" className="input w-3/5 mb-5" />
                    </label>
